...
@OnlyIn(Dist.CLIENT)
public class DiamondElytraModel<T extends LivingEntity> extends AgeableListModel<T> {
   public static final ModelLayerLocation WINGS_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ElytraChestplates.MOD_ID, "diamond_elytra"), "main");
