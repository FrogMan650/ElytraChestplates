...
@OnlyIn(Dist.CLIENT)
public class NetheriteElytraModel<T extends LivingEntity> extends AgeableListModel<T> {
   public static final ModelLayerLocation WINGS_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ElytraChestplates.MOD_ID, "netherite_elytra"), "main");
   private final ModelPart rightWing;
   private final ModelPart leftWing;

   public NetheriteElytraModel(ModelPart pRoot) {
