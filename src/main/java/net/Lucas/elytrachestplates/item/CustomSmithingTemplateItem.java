...
public class CustomSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final String DESCRIPTION_ID = Util.makeDescriptionId("item", new ResourceLocation("elytrachestplates:elytra_smithing_template"));
    private static final ChatFormatting TITLE_FORMAT = ChatFormatting.GRAY;
    private static final ChatFormatting DESCRIPTION_FORMAT = ChatFormatting.BLUE;
    private static final Component ELYTRA_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("elytrachestplates:smithing_template.elytra_upgrade"))).withStyle(DESCRIPTION_FORMAT);
    private static final Component ELYTRA_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("elytra"))).withStyle(DESCRIPTION_FORMAT);
    private static final Component ELYTRA_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", new ResourceLocation("elytrachestplates:elytra_upgrade"))).withStyle(TITLE_FORMAT);
    private static final Component ELYTRA_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("elytrachestplates:smithing_template.elytra_upgrade.base_slot_description")));
    private static final Component ELYTRA_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("elytrachestplates:smithing_template.elytra_upgrade.additions_slot_description")));
